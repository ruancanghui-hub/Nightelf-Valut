...
description: Use when a user uploads a UI screenshot or mockup with red rectangles marking icons, illustrations, controls, or when they also want the page background regenerated as separate code-ready assets.
---
